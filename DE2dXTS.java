// DE2dXTS.java CS5125/6025 Cheng 2019
// Implementing XTS-AES decryption
// Usage: java DE2dXTS doublekey tweak < DE2testXTS.de2 > original.txt

import java.io.*;
import java.util.*;

public class DE2dXTS{
 ...
 void inverseAddRoundKey1(int round){ // Your code from DE1B
   for (int k = 0; k < blockSize; k++) 
...
public static void main(String[] args){
   if (args.length < 2){
     System.err.println("Usage: java DE2dXTS doublekey tweak < DE2testXTS.de2 > original.txt");
     return;
   }
   DE2dXTS de2 = new DE2dXTS();
   de2.makeLog();
   de2.buildS(); 
   de2.readKey(args[0]);
   de2.expandKey();
   de2.readTweak(args[1]);
   de2.decrypt();
}
}
