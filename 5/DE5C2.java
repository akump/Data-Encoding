...
// DE5C2.java CS5125/6025 Cheng 2019
// RSA-PSS encoding 
// Usage:  java DE5C2 rsaKeys < message > signature
...
public class DE5C2 {
  ...
  public static void main(String[] args) {
    if (args.length < 1) {
      System.out.println("Usage: java DE5C2 rsaKeys < message > signature");
      return;
    }
    DE5C2 de5 = new DE5C2();
    de5.readPrivateKey(args[0]);
    de5.sign();
    de5.printSignature();
  }
}
