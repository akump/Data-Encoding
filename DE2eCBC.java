// DE2eCBC.java CS5125/6025 Cheng 2019
// Implementing AES encryption with CBC mode, IV = 0
// Usage: java DE2eCBC key < original > DE2testCBC.de2

import java.io.*;
import java.util.*;

public class DE2eCBC{
...
public static void main(String[] args){
   if (args.length < 1){
     System.err.println("Usage: java DE2eCBC key < original > DE2testCBC.de2");
     return;
   }
   DE2eCBC de2 = new DE2eCBC();
   de2.makeLog();
   de2.buildS(); 
   de2.readKey(args[0]);
   de2.expandKey();
