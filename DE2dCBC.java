// DE2dCBC.java CS5125/6025 Cheng 2019
// Implementing AES decryption with CBC mode, IV = 0
// Usage: java DE2dCBCB key < DE2testCBC.de2 > originalCBC.txt

import java.io.*;
import java.util.*;

public class DE2dCBC{
 ...
 void decrypt(){  // inverse of DE2eCBC.encrypt()
...
public static void main(String[] args){
   if (args.length < 1){
     System.err.println("Usage: java DE2dCBC key < DE2testCBC.de2 > originalCBC.txt");
     return;
   }
   DE2dCBC de2 = new DE2dCBC();
   de2.makeLog();
   de2.buildS(); 
   de2.readKey(args[0]);
   de2.expandKey();
