// DE2eXTS.java CS5125/6025 Cheng 2019
// Implementing XTS-AES encryption 
// Usage: java DE2eXTS doublekey tweak < original > DE2testXTS.de2

import java.io.*;
import java.util.*;

public class DE2eXTS{
...
public static void main(String[] args){
   if (args.length < 2){
     System.err.println("Usage: java DE2eXTS doublekey tweak < original > DE2testXTS.de2");
     return;
   }
   DE2eXTS de2 = new DE2eXTS();
   de2.makeLog();
   de2.buildS(); 
   de2.readKey(args[0]);
   de2.expandKey();
