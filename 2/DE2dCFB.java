// DE2dCFB.java CS5125/6025 Cheng 2019
// Implementing AES decryption with CFB mode, IV = 0, s = 8
// Usage: java DE2dCFB key < DE2testCFB.de2 > original.txt

import java.io.*;
import java.util.*;

public class DE2dCFB{
...
public static void main(String[] args){
   if (args.length < 1){
     System.err.println("Usage: java DE2dCFB key < DE2testCFB.de2 > original.txt");
     return;
   }
   DE2dCFB de2 = new DE2dCFB();
   de2.makeLog();
   de2.buildS(); 
   de2.readKey(args[0]);
   de2.expandKey();
