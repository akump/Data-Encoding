// DE2eOFB.java CS5125/025 Cheng 2019
// Implementing AES encryption with OFB mode
// Usage: java DE2eOFB key nonce < original > DE2testOFB.de2

import java.io.*;
import java.util.*;

public class DE2eOFB{
...
public static void main(String[] args){
   if (args.length < 2){
     System.err.println("Usage: java DE2eOFB key nonce < original > DE2testOFB.de2");
     return;
   }
   DE2eOFB de2 = new DE2eOFB();
   de2.makeLog();
   de2.buildS(); 
   de2.readKey(args[0]);
   de2.expandKey();
   de2.readNonce(args[1]);
   de2.encrypt();
}
}
