// DE2eCFB.java CS5125/6025 Cheng 2019
// Implementing AES encryption with CFB mode, IV = 0, s = 8
// Usage: java DE2eCFBA key < original > DE2testCFB.de2

import java.io.*;
import java.util.*;

public class DE2eCFB{
...
public static void main(String[] args){
   if (args.length < 1){
     System.err.println("Usage: java DE2eCFB key < original > DE2testCFB.de2");
     return;
   }
   DE2eCFB de2 = new DE2eCFB();
   de2.makeLog();
   de2.buildS(); 
   de2.readKey(args[0]);
   de2.expandKey();
