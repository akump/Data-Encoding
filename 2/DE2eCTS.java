// DE2eCTS.java CS5125/6025 Cheng 2019
// Implementing AES encryption with CBC/CTS mode, IV = 0
// Usage: java DE2eCTS key < original > DE2testCTS.de2

import java.io.*;
import java.util.*;

public class DE2eCTS{
...
public static void main(String[] args){
   if (args.length < 1){
     System.err.println("Usage: java DE2eCTS key < original > DE2testCTS.de2");
     return;
   }
   DE2eCTS de2 = new DE2eCTS();
   de2.makeLog();
   de2.buildS(); 
   de2.readKey(args[0]);
   de2.expandKey();
